  ...
  return(
    <div className="bg-cream py-5 px-10">
      ...
      <div className="flex gap-10 mt-5">
        ...
        <Link href='/admin/scholarships/view' className="bg-cyan-900 text-cream px-4 py-2 rounded-lg font-bold text-lg hover:bg-cyan-800 hover:text-amber-200">View scholarships</Link>
