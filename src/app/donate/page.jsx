    ...
    <div>
      ...
      <div className="bg-amber-100 mx-auto text-center w-1/2 px-8 py-8 pb-12 rounded-xl box-pop">
        ...
        <div className="flex justify-center gap-5">
          ...
          <Link href={'/contact'} className="bg-red-800 px-4 py-2 rounded-xl text-xl font-semibold text-amber-100 box-pop hover:bg-red-900 hover:text-amber-50">Contact us</Link>
        </div>
      </div>
    </div>
  )
